...
import { AnalyticsFaceViewsEntity } from '../entities';
...
export class FaceViewsService {
    constructor(
        @InjectRepository(AnalyticsFaceViewsEntity)
        private readonly faceViewsRepo: Repository<AnalyticsFaceViewsEntity>,
